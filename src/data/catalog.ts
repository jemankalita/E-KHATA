...
export const PRODUCT_CATALOG: Product[] = [
  ...
  { id: 'maggi', name: 'Maggi', aliases: ['maggi noodles', 'noodles'], unitPrice: 14 },
  ...
  { id: 'milk', name: 'Milk', aliases: ['amul milk', 'toned milk'], unitPrice: 32 },
  ...
  { id: 'chips', name: 'Chips', aliases: ['lays', 'potato chips'], unitPrice: 20 },
